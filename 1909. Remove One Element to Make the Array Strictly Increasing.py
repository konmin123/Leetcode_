...
is already strictly increasing, return true. The array nums is strictly
...
assert Solution.can_be_increasing([1, 2, 10, 5, 7])
assert not Solution.can_be_increasing([1, 1, 1])
