...
is before the second occurrence of b. s will contain at least one letter that
appears twice.
...
assert Solution.repeated_character('abccbaacz') == 'c'
assert Solution.repeated_character('abcdd') == 'd'
assert Solution.repeated_character('aa') == 'a'
