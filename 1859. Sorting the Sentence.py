...
or "is2 sentence4 This1 a3". Given a shuffled sentence s containing no more
...
1 to 9. The number of words in s is between 1 and 9.
...
class Solution:
    ...
    def sort_sentence(s: str) -> str:
        sort_list = sorted(s.split(), key=lambda x: x[-1])
        return " ".join([x[:-1] for x in sort_list])


assert Solution.sort_sentence("is2 sentence4 This1 a3") == "This is a sentence"
assert Solution.sort_sentence("Myself2 Me1 I4 and3") == "Me Myself and I"
